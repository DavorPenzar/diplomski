 ...
 *
 * @param x_min
 *     Minimal value allowed for the x-coordinates of the points.
 *
 * @param x_max
 *     Maximal value allowed for the x-coordinates of the points.
 *
 * @param y_min
 *     Minimal value allowed for the y-coordinates of the points.
 *
 * @param y_max
 *     Maximal value allowed for the y-coordinates of the points.
 *
 * @return
 *     Array of points of size 2 * `n`.  The array is organised as
 ...
 *
 *     The x-coordinates are generated by calling the `rrand` function with
 *     parameters `x_min` and `x_max` while the y-coordinates are generated by
 *     calling the `rrand` function with parameters `y_min` and `y_max`.  The
...
#endif /* __cplusplus */
{
    ...
    do
    {
        ...
        for (i = 0U; i / 2U < n; ++i)
            *(P + i) = (i & 1U) ? rrand(y_min, y_max) : rrand(x_min, x_max);
    }
    while (false);
 ...
 *     polygon (simplifiable or not) than the function `random_polygon`.
 *
 *     The x-coordinates are generated by calling the `rrand` function with
 *     parameters `x_min` and `x_max` while the y-coordinates are generated by
 *     calling the `rrand` function with parameters `y_min` and `y_max`.  The
 ...
 *     all the points are generated (no value is passed to the next iteration).
 *
...
#endif /* __cplusplus */
{
    ...
    do
    {
        ...
        do
        {
            ...
            *x_i0 = rrand(x_min, x_max);
            *y_i0 = rrand(y_min, y_max);
            ...
            *x_i1 = rrand(x_min, x_max);
            *y_i1 = rrand(y_min, y_max);
