...
%\logo{\includegraphics[width = 15mm]{PMF-logo.pdf}}
...
\begin{document}
    ...
    \begin{frame}{Neprekidnost svojstvenih vrijednosti Laplaceovog operatora}
        \only<1>{%
            \begin{theorem}
                Za svaki $ k \in \positives{\naturals} $ parcijalno preslikavanje $ \lambda_{k} \colon \powerset \left( \reals^{n} \right) \partto \intervaloo{0}{{+ \infty}} $ je neprekidno.~\cite[418--424]{bib:Courant53}
            \end{theorem}%
        }%
        \only<2->{%
    ...
    \begin{frame}{Vizualizacija poligona}
            ...
            \begin{columns}
                \begin{column}{0.5\textwidth}
                    ...
                    {%
                        ...
                        \fcolorbox{RoyalBlue}{white}{\includegraphics{figures/triangle_mesh.png}}%
                    }
                    \\
                    Cijeli trokut
                \end{column}
                \begin{column}{0.5\textwidth}
                    ...
                    {%
                        \setlength{\fboxsep}{0pt}%
                        \setlength{\fboxrule}{1pt}%
                        \fcolorbox{RoyalBlue}{white}{\includegraphics{figures/triangle_mesh_zoom.png}}%
                    }
                    \\
                    Dio uz rub trokuta
                \end{column}
        ...
        \only<2->{%
            ...
            \only<2>{%
                \begin{definition}
                    \defined{Dubina} skupa $ S \subseteq \reals^{n} $ funkcija je $ \deepness_{S} \colon \reals^{n} \to \intervalcc{0}{{+ \infty}} $ t.\ d.
                    \begin{equation*}
            ...
            \only<3->{%
                ...
                {%
                    \setlength{\fboxsep}{0pt}%
                    \setlength{\fboxrule}{1pt}%
                    \fcolorbox{RoyalBlue}{white}{\includegraphics{figures/triangle_deepness.png}}%
                }
                \\
    ...
    \begin{frame}{Neuronska mreža}
        \only<1>{%
            ...
            \begin{enumerate}
                \item duljine stranica u silaznom poretku---zapravo samo $ b , c $
    ...
    \begin{frame}{Uspješnost modela}
        ...
        \only<2>{%
            \framesubtitle{Na donjih $ \unit[\numprint{90}]{\%} $ vrijednosti}
        ...
        \only<3->{%
            \framesubtitle{Zastupljenost donjih $ \unit[\numprint{90}]{\%} $ vrijednosti}
